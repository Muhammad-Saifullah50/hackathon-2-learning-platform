...
from sqlalchemy import Column, String, DateTime, ForeignKey, Integer, Date, CheckConstraint
...
class User(Base, TimestampMixin, SoftDeleteMixin):
    ...
    module_mastery = relationship("UserModuleMastery", back_populates="user", cascade="all, delete-orphan")
...
class UserStreak(Base, TimestampMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint('longest_streak >= current_streak', name='check_longest_streak_valid'),
    )
